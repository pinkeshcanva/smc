...
class _FoodBankScreenState extends State<FoodBankScreen> {
  ...
  Widget build(BuildContext context) {
    List<Map<String, dynamic>> foodBankList = [
      {
        'label': 'Food Bank 1',
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) => Card(
                    child: InkWell(
                      onTap: foodBankList[index]['onTap'],
                      child: ListTile(
                        ...
                        title: labels(
                          text: foodBankList[index]['label'].toString(),
                          size: 17,
                          textAlign: TextAlign.left,
                          color: AppColors.darkTextColor,
                        ),
                        subtitle: labels(
                          text: foodBankList[index]['date'].toString(),
                          textAlign: TextAlign.left,
                          color: AppColors.darkTextColor,
                        ),
                        trailing: labels(
                          text: foodBankList[index]['place'].toString(),
                          color: AppColors.darkTextColor,
                        ),
                      ),
                    ),
